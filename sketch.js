...
function setup() {
	...
	boxleftSprite=createSprite(200, 600, 20,100);
	 ...
	 groundSprite=createSprite(width/2, height-35, width,10);
	groundSprite.shapeColor=color(255)
	boxbottomSprite=createSprite(300, 650, 20,100);
	 boxbottomSprite.shapeColor=color(255,0,0);
	  boxbottomBody = Bodies.rectangle(300, 650, 20,100 ,
		 {isStatic:true} );
	 World.add(world, boxLeftBody);

	 groundSprite=createSprite(width/2, height-35, width,10);
	 groundSprite.shapeColor=color(255)
	 boxrightSprite=createSprite(400, 600, 20,100);
